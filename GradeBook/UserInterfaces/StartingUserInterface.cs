...
namespace GradeBook.UserInterfaces
{
    public static class StartingUserInterface
    {
        ...
        public static void CreateCommand(string command)
        {
            ...
            if (parts.Length != 4)
            {
                Console.WriteLine("Command not valid, Create requires a name, type of gradebook, if it's " +
                    "weighted (true / false).");
                return;
            }
            var name = parts[1];
        ...
        public static void HelpCommand()
        {
            ...
            Console.WriteLine("Create 'Name' 'Type' 'Weighted' - Creates a new gradebook where 'Name' is the name " +
                "of the gradebook, 'Type' is what type of grading it should use, and 'Weighted' is whether or " +
                "not grades should be weighted (true or false).");
            Console.WriteLine();
